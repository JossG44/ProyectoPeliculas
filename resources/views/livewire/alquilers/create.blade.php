    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Insertar alquiler</h5>
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="soc_id" type="text" class="form-control" id="soc_id" placeholder="ID Socio">@error('soc_id') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
